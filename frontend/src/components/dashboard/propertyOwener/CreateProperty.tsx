...
const pricingSchema = z
  ...
  .refine(
    (data) => {
      return (
        data.hourlyRate || data.dailyRate || data.weeklyRate || data.monthlyRate
      );
    },
    {
      message:
  ...
  return {
    ...
    pricing: {
      ...
      dailyRate: data.pricing.dailyRate
        ? Number(data.pricing.dailyRate)
        : undefined,
      weeklyRate: data.pricing.weeklyRate
        ? Number(data.pricing.weeklyRate)
        : undefined,
      monthlyRate: data.pricing.monthlyRate
        ? Number(data.pricing.monthlyRate)
        : undefined,
      cleaningFee: Number(data.pricing.cleaningFee || 0),
      overtimeHourlyRate: data.pricing.overtimeHourlyRate
        ? Number(data.pricing.overtimeHourlyRate)
        : undefined,
    },
    location: {
      ...data.location,
      distanceFromMetro: data.location.distanceFromMetro
        ? Number(data.location.distanceFromMetro)
        : undefined,
      distanceFromBusStop: data.location.distanceFromBusStop
        ? Number(data.location.distanceFromBusStop)
        : undefined,
      distanceFromRailway: data.location.distanceFromRailway
        ? Number(data.location.distanceFromRailway)
        : undefined,
    },
    bookingRules: {
      ...data.bookingRules,
...
const CreateProperty = () => {
  ...
  const furnishingLevels = ["unfurnished", "semi_furnished", "fully_furnished"];
  ...
  const updateTimeSlot = (
    index: number,
    field: keyof (typeof watchedTimeSlots)[0],
    value: any
  ) => {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="nearestMetroStation">
                ...
                <div className="space-y-2">
                  <Label htmlFor="distanceFromMetro">
                ...
                <div className="space-y-2">
                  <Label htmlFor="distanceFromBusStop">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) =>
                      setValue("furnishingLevel", value)
                    }
                  >
                    <SelectTrigger>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="overtimeHourlyRate">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.totalCostPerSeat && (
                      <p className="text-red-500 text-sm">
                        {errors.totalCostPerSeat.message}
                      </p>
                    )}
                  </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setValue("isPriceNegotiable", checked as boolean)
                        }
                      />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="checkoutGracePeriod">
                    Checkout Grace Period (min)
                  </Label>
                  <Input
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) =>
                      setValue("policies.guestPolicy", value as any)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) =>
                      setValue("policies.smokingPolicy", value as any)
                    }
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="allowed">Allowed</SelectItem>
                      <SelectItem value="not_allowed">Not Allowed</SelectItem>
                      <SelectItem value="designated_areas">
                        Designated Areas
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) =>
                      setValue("policies.petPolicy", value as any)
                    }
                    defaultValue="not_allowed"
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  <Label htmlFor="foodAndBeveragePolicy">
                    Food & Beverage Policy
                  </Label>
                  <Select
                    onValueChange={(value) =>
                      setValue("policies.foodAndBeveragePolicy", value as any)
                    }
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="allowed">Allowed</SelectItem>
                      <SelectItem value="not_allowed">Not Allowed</SelectItem>
                      <SelectItem value="outside_food_not_allowed">
                ...
                <div className="md:col-span-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setValue(
                          "policies.eventHostingAllowed",
                          checked as boolean
                        )
                      }
                    />
                    <Label htmlFor="eventHostingAllowed">
                      Event hosting allowed
                    </Label>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="isSaturdayOpened"
                    onCheckedChange={(checked) =>
                      setValue("isSaturdayOpened", checked as boolean)
                    }
                    defaultChecked={true}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="isSundayOpened"
                    onCheckedChange={(checked) =>
                      setValue("isSundayOpened", checked as boolean)
                    }
                  />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    Select dates when the property is not available
                  </p>
